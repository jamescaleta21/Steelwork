...
(
    ...
    WHERE s.ROUTINE_TYPE = 'PROCEDURE' -- Validación del tipo
          ...
          AND s.ROUTINE_NAME = 'USP_RESPONSABLE_DELETE' -- Validación del nombre
)
BEGIN
    DROP PROC [sw].[USP_RESPONSABLE_DELETE];
END;
GO
/*
SW.USP_RESPONSABLE_DELETE '01',1,'PEPITO'
*/
CREATE PROCEDURE [sw].[USP_RESPONSABLE_DELETE]
(
    @codCia CHAR(2),
    @responsableId INT,
