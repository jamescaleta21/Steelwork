...
(
    ...
    WHERE s.ROUTINE_TYPE = 'PROCEDURE' -- Validación del tipo
          ...
          AND s.ROUTINE_NAME = 'USP_PROVEEDOR_DELETE' -- Validación del nombre
)
BEGIN
    DROP PROC [sw].[USP_PROVEEDOR_DELETE];
END;
GO
/*
SW.USP_PROVEEDOR_DELETE '01',1,'PEPITO'
*/
CREATE PROCEDURE [sw].[USP_PROVEEDOR_DELETE]
(
    @codCia CHAR(2),
    @proveedorId INT,
