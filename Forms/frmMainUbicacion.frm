...
Begin VB.Form frmMainUbicacion 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Maestro de Ubicación"
   ClientHeight    =   5880
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9480
   ...
   EndProperty
   Icon            =   "frmMainUbicacion.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSComctlLib.Toolbar tbCategoria 
      ...
      EndProperty
   End
   Begin MSComctlLib.ImageList iUbicacion 
      Left            =   9720
      Top             =   5880
      _ExtentX        =   1005
      _ExtentY        =   1005
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":058A
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":0924
            Key             =   "Save"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":0CBE
            Key             =   "edit"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":1058
            Key             =   "undo"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":13F2
            Key             =   "desactive"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":198C
            Key             =   "active"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":1F26
            Key             =   "exit"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMainUbicacion.frx":22C0
            Key             =   "ubicacion"
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab SSTCategoria 
      ...
      TabsPerRow      =   2
      TabHeight       =   520
      TabCaption(0)   =   "Ubicación"
      TabPicture(0)   =   "frmMainUbicacion.frx":285A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "ComActivo"
      Tab(0).Control(1)=   "txtDenominacion"
      Tab(0).Control(2)=   "Label4"
      Tab(0).Control(3)=   "lblUbicacionId"
      Tab(0).Control(4)=   "Label3"
      Tab(0).Control(5)=   "Label2"
      Tab(0).ControlCount=   6
      TabCaption(1)   =   "Listado"
      TabPicture(1)   =   "frmMainUbicacion.frx":2876
      ...
      Begin VB.ComboBox ComActivo 
         Height          =   315
         ItemData        =   "frmMainUbicacion.frx":2892
         Left            =   -71400
         List            =   "frmMainUbicacion.frx":289C
   ...
   End
End
Attribute VB_Name = "frmMainUbicacion"
...
configurarLv
ubicacionSearch Me.txtSearch.Text
Estado_Botones InicializarFormulario
Me.tbCategoria.ImageList = Me.iUbicacion
Me.tbCategoria.Buttons(1).Image = Me.iUbicacion.ListImages(1).index
Me.tbCategoria.Buttons(2).Image = Me.iUbicacion.ListImages(2).index
Me.tbCategoria.Buttons(3).Image = Me.iUbicacion.ListImages(3).index
Me.tbCategoria.Buttons(4).Image = Me.iUbicacion.ListImages(4).index
Me.tbCategoria.Buttons(5).Image = Me.iUbicacion.ListImages(5).index
Me.tbCategoria.Buttons(6).Image = Me.iUbicacion.ListImages(6).index
Me.tbCategoria.Buttons(7).Image = Me.iUbicacion.ListImages(7).index
End Sub

Private Sub configurarLv()
Me.lvListado.Icons = Me.iUbicacion
Me.lvListado.SmallIcons = Me.iUbicacion
    ...
    With Me.lvListado
        ...
        .ColumnHeaders.Add , , "Denominación", 5000
...
Private Sub ubicacionSearch(xdato As String)

    On Error GoTo xSearch

    Me.lvListado.ListItems.Clear
    LimpiaParametros oCmdEjec
    oCmdEjec.CommandText = "[sw].[USP_UBICACION_SEARCH]"
    ...
    If Not oRSmain.EOF Then
        ...
        Do While Not oRSmain.EOF
            Set itemX = Me.lvListado.ListItems.Add(, , oRSmain!ubicacionId, Me.iUbicacion.ListImages(1).key, Me.iUbicacion.ListImages(8).key)
...
Sub Mandar_Datos()
    ...
    With Me.lvListado
        Me.lblUbicacionId.Caption = .SelectedItem.Text
    ...
    Select Case Button.index
        ...
        Case 2 'Guardar
            ...
            Else
                ...
                If VNuevo Then
                    oCmdEjec.CommandText = "[sw].[USP_UBICACION_REGISTER]"
                Else
                    oCmdEjec.CommandText = "[sw].[USP_UBICACION_UPDATE]"
                ...
                If Not VNuevo Then oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@ubicacionId", adInteger, adParamInput, , Me.lblUbicacionId.Caption)
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@DESCRIPCION", adVarChar, adParamInput, 100, Trim(Me.txtDenominacion.Text))
...
grabar:
        ...
        Case 5 'Desactivar
            ...
            If MsgBox("¿Desea continuar con la Operación?", vbQuestion + vbYesNo, Pub_Titulo) = vbYes Then
                ...
                LimpiaParametros oCmdEjec
                oCmdEjec.Prepared = True
                oCmdEjec.CommandText = "[sw].[USP_UBICACION_STATUS]"
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@CodCia", adChar, adParamInput, 2, LK_CODCIA)
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@ubicacionId", adInteger, adParamInput, , Me.lblUbicacionId.Caption)
...
Activa:
        ...
        Case 7 'ELIMINAR
            ...
            If MsgBox("¿Desea continuar con la Operación?", vbQuestion + vbYesNo, Pub_Titulo) = vbYes Then
                ...
                LimpiaParametros oCmdEjec
                oCmdEjec.Prepared = True
                oCmdEjec.CommandText = "[sw].[USP_UBICACION_DELETE]"
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@CodCia", adChar, adParamInput, 2, LK_CODCIA)
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@ubicacionId", adInteger, adParamInput, , Me.lblUbicacionId.Caption)
                oCmdEjec.Parameters.Append oCmdEjec.CreateParameter("@CUREGISTRO", adVarChar, adParamInput, 20, LK_CODUSU)
...
KeyAscii = Mayusculas(KeyAscii)
If KeyAscii = vbKeyReturn Then ubicacionSearch Me.txtSearch.Text
End Sub
